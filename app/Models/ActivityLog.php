...
class ActivityLog extends Model
{
  ...
  protected $fillable = ['log_name', 'description', 'subject_type', 'subject_id', 'event', 'causer_type', 'causer_id', 'prev_properties', 'properties', 'batch_uuid', 'ip_address', 'country', 'city', 'region', 'postal', 'geolocation', 'timezone', 'user_agent', 'referer'];
